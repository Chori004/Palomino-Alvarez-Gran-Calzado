...
if (isset($_POST["usuario"])) {
  ...
  if ($usuario == "admin" and $contrasena == "admin") {
    ...
    $error = "Contraseña incorrecta.";
      ...
      $consulta_user_id = mysqli_query($conexion, "SELECT id_usuario FROM usuario WHERE nombre_usuario = '" . $fila_usuario['nombre_usuario'] . "'");
      $usuario_data = mysqli_fetch_assoc($consulta_user_id);
      ...
      while ($fila = mysqli_fetch_assoc($resultado_db)) {
          $clave_carrito = $fila['id_producto'] . "_" . $fila['talle'];
