...
$consulta_productos = mysqli_query($conexion, "SELECT * FROM productos WHERE activo = 'S' AND id_categoria_fk = 2 " . $where_tipo);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-4">
          ...
          <li class="nav-item dropdown">
              <a class="nav-link active fs-5 dropdown-toggle" href="mujer.php">Mujer</a>
              <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="mujer.php">Todos</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Mocasin">Mocasines</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Tacon">Tacones</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Stilleto">Stilletos</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Cuña">Cuñas</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Botin">Botines</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Bota">Botas</a></li>
                  <li><a class="dropdown-item" href="mujer.php?tipo=Sandalia">Sandalias</a></li>
              </ul>
          </li>
          <li class="nav-item dropdown">
              ...
              <form action="agregar_carrito.php" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <div class="d-flex flex-wrap gap-2">
                    ...
                    <?php
                    $talles_mujer = [35, 35.5, 36, 36.5, 37, 37.5, 38, 38.5, 39, 39.5, 40, 40.5, 41];
                    $id_actual = $producto['id_producto'];

                    foreach ($talles_mujer as $talle) {
...
<footer>
  ...
  <div class="row">
    <div class="col">
      <p>Encuéntranos en Av. Cabildo 1979</p>
